"""
Django settings for flashblocproject project.
...
SECRET_KEY = 'django-insecure-oo%tcvx-er(pz2hf3b*^gau(nxhhk=x9@i1z&6abwv5u^n6neh'
...
INSTALLED_APPS = [
    ...
    'corsheaders', 
    'rest_framework', #when to include this?
...
SIMPLE_JWT = {
    ...
    'USER_ID_CLAIM': 'user_wallet_address',
