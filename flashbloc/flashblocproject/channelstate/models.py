...
class Ledger(models.Model):
    ...
    locked_recipient_bal = models.DecimalField(decimal_places=1, blank=True, null=True, max_digits=19)
    locked_initiator_bal = models.DecimalField(decimal_places=1, blank=True, null=True, max_digits=19)
    latest_tx = models.ForeignKey(TransactionLocal, null=True, blank=True, on_delete=models.CASCADE, related_name="latestTx")
    latest_recipient_bal = models.DecimalField(decimal_places=1, blank=True, null=True, max_digits=19)
    latest_initiator_bal = models.DecimalField(decimal_places=1, blank=True, null=True, max_digits=19)
    latest_ptp = models.ForeignKey(PtpLocal, null=True, blank=True, on_delete=models.CASCADE, related_name="latestPtp")
    ptp_recipient_bal = models.DecimalField(decimal_places=1, blank=True, null=True, max_digits=19)
    ptp_initiator_bal = models.DecimalField(decimal_places=1, blank=True, null=True, max_digits=19)
    topup_recipient_bal = models.DecimalField(decimal_places=1, blank=True, null=True, max_digits=19)
    topup_initiator_bal = models.DecimalField(decimal_places=1, blank=True, null=True, max_digits=19)
